...
// ES6
let welcomeES6 = () => {
    console.log('Hello from ES6') // tek satır olacaksa süslü paranteze gerek yok
};
...
//let multiplyES6 = (x,y) => x*y; // süslü yoksa return de yok!
...
console.log(getProductES5('1','Samsung S10 Lite'));
...
console.log(getProductES6('1','Samsung M51'));
